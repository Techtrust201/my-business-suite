...
-- Politique pour bank_accounts : utilisateurs de l'organisation
...
CREATE POLICY "Users can update bank accounts of their organization"
    ON public.bank_accounts
    FOR UPDATE
    USING (
        organization_id IN (
...
CREATE POLICY "Users can delete bank accounts of their organization"
    ON public.bank_accounts
    FOR DELETE
    USING (
        organization_id IN (
...
-- Activer RLS sur bank_transactions
ALTER TABLE public.bank_transactions ENABLE ROW LEVEL SECURITY;

-- Politique pour bank_transactions : utilisateurs de l'organisation
CREATE POLICY "Users can view bank transactions of their organization"
...
CREATE POLICY "Users can update bank transactions of their organization"
    ON public.bank_transactions
    FOR UPDATE
    USING (
        organization_id IN (
...
CREATE POLICY "Users can delete bank transactions of their organization"
    ON public.bank_transactions
    FOR DELETE
    USING (
        organization_id IN (
...
-- =============================================
-- FONCTION: Mettre à jour le solde du compte
-- =============================================
...
-- Trigger pour mettre à jour le solde après insert/update/delete
